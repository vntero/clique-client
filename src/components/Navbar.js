...
const Navbar = (props) => {
  ...
  return (
    <AppBar position="static" style={{ background: '#5F939A'}}>
          ...
          <Box sx={{ flexGrow: 0 }}>
            <Tooltip title="You">
              <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                <Avatar alt="Ironhacker" src="/static/images/avatar/2.jpg" />
              </IconButton>
            </Tooltip>
            <Menu
              sx={{ mt: '45px' }}
            ...
            >
                ...
                <MenuItem onClick={handleCloseNavMenu}>
                  <Typography textAlign="center" onClick={props.onLogout}>Logout</Typography>
                </MenuItem>
